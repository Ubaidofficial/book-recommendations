...
- **12 routes** — homepage, 5 index pages, 4 detail page types, about, methodology, privacy, terms, report-issue
...
- **List detail pages** — 48 books ranked by position, related lists, fallback descriptions, about sections
- **Series detail pages** — 48 books in reading order, #N badges, related series, about sections
...
- **Visual theme** — purple/indigo accent (`#5b4fcf`), near-white background (`#faf9f7`), charcoal text (`#1b1b1f`), rounded-2xl editorial cards, purple accent badges, responsive mobile menu, original abstract recommendation SVG
